window.addEventListener('load', function () {
    ...
    class Player {
        ...
        draw(context) {
            ...
            //this.drawCollisionCircle(context);
        }
        update(input, deltaTime, enemies) {
            //collision det
            enemies.forEach((enemy) => {
                const dx =
                    (enemy.x + enemy.width / 2 - 25) - (this.x + this.width / 2 + 10);
                const dy =
                    enemy.y + enemy.height / 2 - (this.y + this.height / 2 + 30);
