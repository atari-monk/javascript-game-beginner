...
samples["state3"] = {
    page: statePage1,
    script: "State3/" + script + "3" + js
};
samples["state4"] = {
    page: statePage1,
    script: "State4/" + script + "4" + js
};
samples["state5"] = {
    page: statePage1,
    script: "State5/" + script + "5" + js
};
samples["state6"] = {
    page: statePage1,
...
const game2dPage3 = "Game2d/game2d3.html";
samples["game2d5"] = {
    page: game2dPage3,
...
samples["game2d7"] = {
    page: game2dPage3,
    script: "Page7/" + script + "7" + js
};
samples["game2d8"] = {
    page: game2dPage3,
    script: "Page8/" + script + "8" + js
};
const game2dPage4 = "Game2d/game2d4.html";
samples["game2d9"] = {
    page: game2dPage4,
    script: "Page9/" + script + "9" + js
};
samples["game2d10"] = {
    page: game2dPage4,
    script: "Page10/" + script + "10" + js
};
samples["game2d11"] = {
    page: game2dPage4,
    script: "Page11/" + script + "11" + js
};
samples["game2d12"] = {
    page: game2dPage4,
